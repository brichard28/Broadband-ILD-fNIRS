...
sgtitle('\DeltaHbO (\muM)','FontSize',18,'FontWeight','bold')

%% HbR
speech_masker_data = readtable("C:\\Users\\benri\\Documents\\GitHub\\SRM-NIRS-EEG\\ANALYSIS SCRIPTS\\Eli Analysis\\all_subjects_uncorr_block_average_hbr_speech_masker.csv",'format','auto');
noise_masker_data = readtable("C:\\Users\\benri\\Documents\\GitHub\\SRM-NIRS-EEG\\ANALYSIS SCRIPTS\\Eli Analysis\\all_subjects_uncorr_block_average_hbr_noise_masker.csv",'format','auto');
...
sgtitle('\DeltaHbR (\muM)','FontSize',18,'FontWeight','bold')
