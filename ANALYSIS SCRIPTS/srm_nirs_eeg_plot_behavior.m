...
% significance bars
line([1,2],[0.81,0.81],'Color','k','LineWidth',1.5)
text(1.5,0.83,'***','FontSize',14)
line([1,2.5],[0.86,0.86],'Color','k','LineWidth',1.5)
text(1.75,0.88,'***','FontSize',14)
line([1,3.5],[0.91,0.91],'Color','k','LineWidth',1.5)
text(2.25,0.93,'***','FontSize',14)
...
sgtitle('Speech Masker Only','FontSize',18,'FontWeight','bold')

% significance bars
line([1,2.5],[0.2,0.2],'Color','k','LineWidth',1.5)
text(1.65,0.22,'***','FontSize',14)
line([2,2.5],[0.25,0.25],'Color','k','LineWidth',1.5)
text(2.15,0.27,'***','FontSize',14)
line([2.5,3.5],[0.3,0.3],'Color','k','LineWidth',1.5)
text(2.9,0.32,'***','FontSize',14)
