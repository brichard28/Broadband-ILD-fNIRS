...
hold on
shadedErrorBar(time,smoothdata(squeeze(nanmean(left_hem_attend_left_itd_50,[1,2]) - nanmean(left_hem_attend_right_itd_50,[1,2])),'SmoothingFactor',0.5),std(squeeze(nanmean(left_hem_attend_left_itd_50,2) - nanmean(left_hem_attend_right_itd_50,2)),[],1)./(sqrt(length(subjID))-1),'lineProps','-r')
shadedErrorBar(time,smoothdata(squeeze(nanmean(left_hem_attend_left_itd_500,[1,2]) - nanmean(left_hem_attend_right_itd_500,[1,2])),'SmoothingFactor',0.5),std(squeeze(nanmean(left_hem_attend_left_itd_500,2) - nanmean(left_hem_attend_right_itd_500,2)),[],1)./(sqrt(length(subjID))-1),'lineProps','-g')
shadedErrorBar(time,smoothdata(squeeze(nanmean(left_hem_attend_left_ild_10,[1,2]) - nanmean(left_hem_attend_right_ild_10,[1,2])),'SmoothingFactor',0.5),std(squeeze(nanmean(left_hem_attend_left_ild_10,2) - nanmean(left_hem_attend_right_ild_10,2)),[],1)./(sqrt(length(subjID))-1),'lineProps','-b')
shadedErrorBar(time,smoothdata(squeeze(nanmean(left_hem_attend_left_ild_70n,[1,2]) - nanmean(left_hem_attend_right_ild_70n,[1,2])),'SmoothingFactor',0.5),std(squeeze(nanmean(left_hem_attend_left_ild_70n,2) - nanmean(left_hem_attend_right_ild_70n,2)),[],1)./(sqrt(length(subjID))-1),'lineProps','-c')
title('Left Hemisphere Attend Left - Attend Right')

subplot(2,1,2) % right Hemisphere attend Left
hold on
shadedErrorBar(time,smoothdata(squeeze(nanmean(right_hem_attend_left_itd_50,[1,2]) - nanmean(right_hem_attend_right_itd_50,[1,2])),'SmoothingFactor',0.5),std(squeeze(nanmean(right_hem_attend_left_itd_50,2) - nanmean(right_hem_attend_right_itd_50,2)),[],1)./(sqrt(length(subjID))-1),'lineProps','-r')
shadedErrorBar(time,smoothdata(squeeze(nanmean(right_hem_attend_left_itd_500,[1,2]) - nanmean(right_hem_attend_right_itd_500,[1,2])),'SmoothingFactor',0.5),std(squeeze(nanmean(right_hem_attend_left_itd_500,2) - nanmean(right_hem_attend_right_itd_500,2)),[],1)./(sqrt(length(subjID))-1),'lineProps','-g')
shadedErrorBar(time,smoothdata(squeeze(nanmean(right_hem_attend_left_ild_10,[1,2]) - nanmean(right_hem_attend_right_ild_10,[1,2])),'SmoothingFactor',0.5),std(squeeze(nanmean(right_hem_attend_left_ild_10,2) - nanmean(right_hem_attend_right_ild_10,2)),[],1)./(sqrt(length(subjID))-1),'lineProps','-b')
shadedErrorBar(time,smoothdata(squeeze(nanmean(right_hem_attend_left_ild_70n,[1,2]) - nanmean(right_hem_attend_right_ild_70n,[1,2])),'SmoothingFactor',0.5),std(squeeze(nanmean(right_hem_attend_left_ild_70n,2) - nanmean(right_hem_attend_left_ild_70n,2)),[],1)./(sqrt(length(subjID))-1),'lineProps','-c')
...
title('Mean Alpha Power (Cue Period: 0-500 ms)','FontSize',18)
ylim([-5 5])
...
% From Wostmann et al 2021
% (Pow_attend_left - Pow_attend_right) / (Pow_attend_left +
% Pow_attend_right)
...
figure;
subplot(2,2,1)
topoplot(spatial_lateralization(1,:),'/home/ben/Documents/GitHub/SRM-NIRS-EEG/chan_locs_pol_PO_ONLY.txt','maplimits',[cmin cmax],'interplimits','head','plotrad',0.6)
colorbar
ax = gca;
ax.CLim = [cmin cmax];
title('ITD50')
...
subplot(2,2,2)
topoplot(spatial_lateralization(2,:),'/home/ben/Documents/GitHub/SRM-NIRS-EEG/chan_locs_pol_PO_ONLY.txt','maplimits',[cmin cmax],'interplimits','head','plotrad',0.6)
colorbar
ax = gca;
ax.CLim = [cmin cmax];
title('ITD500')
...
subplot(2,2,3)
topoplot(spatial_lateralization(3,:),'/home/ben/Documents/GitHub/SRM-NIRS-EEG/chan_locs_pol_PO_ONLY.txt','maplimits',[cmin cmax],'interplimits','head','plotrad',0.6)
colorbar
ax = gca;
ax.CLim = [cmin cmax];
title('ILD10')
...
subplot(2,2,4)
topoplot(spatial_lateralization(4,:),'/home/ben/Documents/GitHub/SRM-NIRS-EEG/chan_locs_pol_PO_ONLY.txt','maplimits',[cmin cmax],'interplimits','head','plotrad',0.6)
colorbar
ax = gca;
ax.CLim = [cmin cmax];
title('ILD70n')
...
% Equation from Wostmann et al 2021
% (Pow_ipsilateral - Pow_contralateral) / (Pow_ipsilateral +
% Pow_contralateral)
